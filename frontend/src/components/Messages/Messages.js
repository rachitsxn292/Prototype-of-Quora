                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Message</label>
                                            <div class="col-lg-10">
                                                <textarea rows="10" cols="30" placeholder="Your Message...." class="form-control" name="content" id="content" value={this.state.value} onChange={this.onChange}></textarea>
                                            </div>    
                                    </div>              
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-send" data-dismiss="modal" onClick={()=>{
